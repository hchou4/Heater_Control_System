...
void Do_Setup_Time(void)
{
    ...
    {   
         if (check_for_button_input() == 1)
         {
             ...
             {
                Do_Beep_Good();//rememmber to enable 
...
void Increase_Time()
{
            switch (Select_Field)               // Increment the proper field
            {
                ...
                case 3:
                    setup_month++;
                    if (setup_month == 12+1) setup_month = 1; 
                    break;
                ...
                case 4:
                    ...
                    switch(setup_month)
                    {
                        ...
                        case 10:
                        case 12:
                            if(setup_day ==31+1) setup_day = 1;
                        break;
                        case 2:
                            if(setup_day ==28+1) setup_day=1;
                        break;
                        case 4:
                        case 6:
                        case 9:
                        case 11:
                            if(setup_day ==30+1) setup_day = 1;
                        break;
                        
                    default:
                        setup_day =0; // should not happen
                        break;
                    }
                    break;
